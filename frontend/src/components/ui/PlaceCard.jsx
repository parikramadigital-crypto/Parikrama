...
const PlaceCard = ({ place }) => {
  return (
    ...
    >
      {/* Image / Placeholder */}
      <div className="h-40 lg:h-60 md:h-60 lg:w-1/2 w-full bg-gray-200 flex items-center justify-center overflow-hidden object-contain ">
      ...
      <div className="p-5 flex flex-col justify-between lg:w-1/2">
        ...
        <div className="flex justify-between text-sm text-gray-500 pt-4">
          <span>
            Exploration time ⏱ : {place?.averageTimeSpent || "NA"} min
          </span>
  ...
  return (
    <div>
      <div className="w-full bg-white border border-gray-200 rounded-t-xl shadow-sm hover:shadow-md transition overflow-hidden flex flex-col pb-2">
        ...
        {/* Content */}
        <div className="py-5 px-3 flex md:flex-row flex-col justify-between">
          <motion.div
          ...
          >
            ...
            {/* Description */}
            <p className="text-sm text-gray-600 text-justify indent-8">
              {place?.description}
            </p>
          </motion.div>
