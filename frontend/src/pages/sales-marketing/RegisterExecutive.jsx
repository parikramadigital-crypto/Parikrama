...
const RegisterExecutive = ({
  ...
  return (
    <div className="bg-neutral-50 rounded-xl flex flex-col justify-start items-center max-h-[90vh] overflow-y-auto p-8 md:p-10">
      <h1 className="text-xl font-semibold mb-6">
        {login === true ? "Executive Login" : "Register New Executive"}
      </h1>

      <form
        ref={formRef}
        onSubmit={login === true ? handleLogin : handleSubmit}
